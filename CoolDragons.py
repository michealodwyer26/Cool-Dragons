...
# Date: 06/04/2017		Album: Absolutely Free  &  Uncle Meat
#------------------------------------------------------------
...
def rpg_fight(user_health, dragon_health):
	blank = ''
	border = '----------------------------------------------------------'
	line10 = ' Sword Slash - 1   Run Away - 3 |    Your Health : %s    |' % user_health
	line20 = ' Kick & Punch - 2               |    Dragon Health : %s  |' % dragon_health
